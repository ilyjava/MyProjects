...
public class CellGUI implements Cell<Graphics> {
    ...
    public CellGUI() {
        ...
        try {
            imgBomb = ImageIO.read(new File("C:\\saper\\bomb.jpg")); // ” ¿«¿“‹ —¬Œ… œ”“‹
            imgFlag = ImageIO.read(new File("C:\\saper\\flag.jpg")); // ” ¿«¿“‹ —¬Œ… œ”“‹
            imgEmpty = ImageIO.read(new File("C:\\saper\\empty.jpg")); // ” ¿«¿“‹ —¬Œ… œ”“‹
        } catch (Exception e) {
