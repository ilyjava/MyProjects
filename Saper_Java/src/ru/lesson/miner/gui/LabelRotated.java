...
public class LabelRotated extends JLabel {
     ...
     */
    public LabelRotated(Icon image, int horizontalAlignment) {
     ...
     *          The icon to use for this label.
     */
    public LabelRotated(Icon image) {
        super(image);
    }
     ...
     *          The horizontal alignment of the text.
     */
    public LabelRotated(String text, Icon icon, int horizontalAlignment) {
     ...
     *          The horizontal alignment of the text.
     */
    public LabelRotated(String text, int horizontalAlignment) {
     ...
     *          The text to display.
     */
    public LabelRotated(String text) {
        super(text);
    }
    ...
    public static void main(String[] args) {
        ...
        LabelRotated rl = new LabelRotated("BLAHBLAH");
